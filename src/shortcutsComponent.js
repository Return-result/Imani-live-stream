    ...
    return (
      <div className="callout">
        <div className="callout-header" onClick={this.toogleExpand}>
          <span> Shortcuts </span>
          <img
            className="callout-header-image-dimensions"
            style={{ marginLeft: "12px", verticalAlign: "middle" }}
            src={showcallout ? close : expand}
            alt="expand"
          />
        </div>
        {showcallout ? (
          <div className="speech-bubble callout-container">
            <p>
              <span>Right arrow key </span> - Volume Up
            </p>
            <p>
              <span>Left arrow key </span> - Volume Down
            </p>
            <p>
              <span>P </span> - Play/Pause
            </p>
            <p>
              <span>M </span> - Mute
            </p>
            <p>
              <span>B </span> - simulate Buffer
            </p>
          </div>
        ) : (
          ""
